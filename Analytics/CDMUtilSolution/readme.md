...
To run CDMUtil from local desktop, you can download and run CDMUtil executable using Command prompt or Powershell. You need to have [.net Core Framework 3.1](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-3.1.32-windows-x64-installer) installed.
